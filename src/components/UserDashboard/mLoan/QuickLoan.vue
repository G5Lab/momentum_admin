    ...
    <div class="container-fluid">
      <div class="d-flex justify-content-center">
        <div class="col-md-9 border p-3 pb-5">
          <p
            class="font-weight-bold p-2 text-center lead"
          >Quick Loan is disbursed instantly (Loan Wallet debited and Main Wallet Credited).</p>
          <p class="m-1">Loan Tenure: 30Days max.</p>

          <p
            class="m-1"
          >Maximum Amount Allowable: 50% of Savings Wallet Balance and/or Term Deposit Balance.</p>
          <p class="m-1">Processing FEE: N1,000 or 5% amount requested whichever that is higher.</p>
          ...
          <div class="col-md-8">
            ...
            <div v-if="mode" class="card shadow justify-content-center mb-4">
              <div class="card-header py-3">
                <h6 class="m-0 font-weight-bold text-primary">- Create Quick Loan</h6>
              </div>
